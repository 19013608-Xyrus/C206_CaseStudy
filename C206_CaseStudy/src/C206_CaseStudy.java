		...
		//Imported from Transaction - Xyrus
				...
				while (option !=6) {
					...
					if(option == 1) {
						...
						if (productOpt == 1) {
							C206_CaseStudy.viewAllProducts(productList);
							
						} else if (productOpt==2 ) {
							products pr = inputProduct();
							C206_CaseStudy.addProducts(productList, pr);
						...
						while (CustomerOpt != 6) {
							...
							if (CustomerOpt == 1) {
								...
								C206_CaseStudy.retrieveAllReturns(returnsList);
								
							} else if (CustomerOpt == 2) {
								//Add customer or Add returns
								Customer customer = inputCustomer();
								C206_CaseStudy.addCustomer(customerList, customer);
							
							} else if (CustomerOpt == 3) {
								//Delete a customer
								Customer customer = inputCustomer();
								C206_CaseStudy.deleteCustomer(customerList, customer);
								...
								C206_CaseStudy.updateReturns(returnsList, returns);
								
								
							} else if (CustomerOpt == 5) {
								// Add customer returns
								Returns returns = inputReturns();
								C206_CaseStudy.addReturns(returnsList, returns);
			...
			// ================================= Option 1 View=================================
				...
				public static void viewAllProducts(ArrayList<products> productList) {
					C206_CaseStudy.setHeader("PRODUCTS LIST");
